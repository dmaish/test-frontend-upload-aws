...
class KeyFeaturesPurpose extends Component {
    ...
    handleSubmit = (e) => {
        ...
        setWizardValues({...this.state, percentageCompletion: 30.7692});
        this.props.history.push('/wizard/volume')
    }
                    ...
                    <div style={{minHeight: '100vh'}} class="col-xl-6 col-lg-6 wizard-div-top">
                        <div style={{height: '100%', position: 'fixed'}} class="row align-items-center animate__animated animate__fadeInRight">
                            <div class="col-xl-12 col-lg-12">
                                <div class='pageTitle'  style={{fontSize: '50px', margin: '15px'}}>Users Pain Points</div>
                                <div style={{margin: '15px'}}>List a pain point for each of your product's Users.</div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            return (
                                                <div style={{width: '100%', marginBottom: '30px'}}>
                                                    <div style={{width: '100%', display: 'inline-block'}}>
                                                        ...
                                                        <textarea onInput={(e) =>this.handleusersPainPointsInput(index, e)} style={{padding: '4px', paddingLeft: '8px', fontSize: '15px', minHeight: '70px', border:'0.5px #a1a9e4 solid', overflow: 'auto', color: 'white', background: 'transparent'}} class="wizard-text-area-input" placeholder="user pain point" name="painPoint" value={eachFeature.painPoint}></textarea>
                                                    </div>
                                            </div>
                                            )
                                        })}
